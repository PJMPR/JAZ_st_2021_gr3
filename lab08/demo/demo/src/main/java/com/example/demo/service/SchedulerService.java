...
import com.example.demo.Quartz.UtillTime;
import com.example.demo.quartz.ScheduleInfo;
...
public class SchedulerService {
    ...
    public Scheduler schedule(final Class jobClass, final ScheduleInfo info){
        final JobDetail jobDetail = UtillTime.buildJobDetail(jobClass, info);
        final Trigger trigger = UtillTime.buildTrigger(jobClass, info);
